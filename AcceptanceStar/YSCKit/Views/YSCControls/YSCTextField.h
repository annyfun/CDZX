...
typedef void (^YSCTextFieldBlock)(NSString *text);
...
@property (nonatomic, copy) YSCTextFieldBlock textChangedBlock;
@property (nonatomic, copy) YSCTextFieldBlock textReturnBlock;
