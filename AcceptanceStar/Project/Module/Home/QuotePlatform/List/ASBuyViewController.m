//
//  ASBuyInformationViewController.m
//  AcceptanceStar
//
...
@implementation ASBuyViewController
...
- (void)viewDidLoad {
    ...
    self.asPopView = [ASPopView CreatePaymentView:PriceTypeBuy];
    ...
    addNObserver(@selector(refreshByNotification), kNotificationRefreshBuyList);
}
...
- (Class)modelClassOfData {
    return ClassOfObject(BondBuyModel);
}
