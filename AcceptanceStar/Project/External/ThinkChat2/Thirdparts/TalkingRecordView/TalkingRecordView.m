...
- (void)recordStart {
    ...
    if (recorder == nil) {
        ...
        NSURL * pathU = [NSURL fileURLWithPath:audioTemporarySavePath];
#elif TARGET_OS_IPHONE
        NSURL * pathU = [NSURL URLWithString:audioTemporarySavePath];
#endif
...
- (void)audio_PCMtoMP3 {
    ...
    @catch (NSException *exception) {
        TCDemoLog(@"%@",[exception description]);
    }
    @finally {
        TCDemoLog(@"MP3 file generated successfully: %@",audioFileSavePath);
    }
